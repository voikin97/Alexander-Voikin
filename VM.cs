...
{
    public class VoikinM
    {
        private MtProtoSender _sender;
        private AuthKey _key;
        private TcpTransport _transport;
        private string _apiHash = "f2627b6051bee8c409f3d59e342e2e47 ";
        private int _apiId = 37128;
        private Session _session;
        private List<DcOption> dcOptions;
        private string f2627b6051bee8c409f3d59e342e2e47;

        public VoikinM(ISessionStore store, string sessionUserId, int apiId, string apiHash)
        {
            _apiHash = f2627b6051bee8c409f3d59e342e2e47;
            _apiId = 37128;
            if (_apiId == 0)
